...
Read `AGENTS.md`, the architecture master, capability ownership and performance
Requirements 016 and 017 under `requirements/009-migration-to-react/`, the
owning domain requirement, current route/domain/repository/provider modules and
tests.
