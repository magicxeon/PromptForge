...
| 006 Revalidation | Expiry/account/mode/model/hash checks at prepare and URL resolution, including expiry during verification. Bounded download verifies original hash. Provider privacy rejection evidence blocks reuse; multi-image evidence does not claim each individual image caused rejection. |
