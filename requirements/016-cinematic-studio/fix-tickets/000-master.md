...
| `CINE-FIX-012` | GCS URL-first Seedance transport with local Base64 fallback, no Asset Library dependency, and honest Generate status | P0 | Pending BytePlus ModelArk Support response; creator contacted support on/before 2026-09-05; local implementation retained |
