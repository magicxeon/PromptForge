# Characters And Library

Status owner: [master](000-master.md). All items below are deferred.
Sources: Page-Enhancement requirement032 P-06/P-07 and master
PENDING-CHARACTER-SOCIAL; existing Profiles/Library capability requirements.

| ID | Item / acceptance when reopened | Owner / dependency |
|---|---|---|
...
Before reopening: read original source behavior, identify the smallest changed
component/service, add isolated source-selection or social-state tests and
verify only affected layouts. No automatic paid generation or asset replacement.
