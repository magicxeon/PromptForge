...
| Visual asset manifest | UI icon, swatch, preview, layout position | `visual-assets/.../manifest.json` or `client/assets/.../manifest.json` |
...
| Individual icon | 512x512 px |
| UI thumb target | 96-160 px displayed |
...
2. Slice or export the asset.
3. Place the file in the category asset folder.
4. Check that the icon is centered and readable at UI card size.
...
```json
{
  ...
  "slug": "downturned",
  "assets": {
    "thumb": "./thumbs/downturned.png",
    "preview": "./preview/downturned.png"
  },
  "alt": {
