...
export function ShareGeneratedDialog({ jobId, trigger }: { jobId: string; trigger?: ReactNode }) {
  ...
  const publish = useMutation({
    mutationFn: (input: { title: string; description: string; promptVisibility: string; visibility: string }) => {
