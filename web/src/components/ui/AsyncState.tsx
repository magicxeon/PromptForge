...
export function ErrorState({
  ...
  return (
    <div className="flex min-h-48 flex-col items-center justify-center border border-[color-mix(in_srgb,var(--theme-danger)_28%,transparent)] bg-[color-mix(in_srgb,var(--theme-danger)_7%,transparent)] p-8 text-center">
      <AlertCircle className="mb-3 size-6 text-[var(--theme-danger)]" aria-hidden="true" />
      <strong>{title}</strong>
      {description ? <p className="mt-2 max-w-xl text-sm text-[var(--mpf-text-muted)]">{description}</p> : null}
